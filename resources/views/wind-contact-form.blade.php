                ...
                @else
                                ...
                                <div>
                                    <label class="checkbox-wrapper">
                                        ...
                                        <span class="text-primary-600 flex flex-col items-center justify-center gap-2">
                                            <img class="w-20 h-20" src="{{ asset('storage/'.$category->logo) }}">
                                            {{ $category->name ?? '' }}
                                        </span>
                    ...
                    @else
                        <div class="max-w-4xl mx-auto text-primary-600 my-4">
                            Sending to: <span class="text-secondary-500 font-semibold">{{ $categories->first()->name ?? '' }}</span>
                        </div>
                    @endif
                @endif
            @endif
