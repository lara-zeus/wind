...
class InstallCommand extends Command
{
    ...
    {
        // publish Wind files
        $this->callSilent('vendor:publish', [ '--tag' => 'wind-migrations', '--force' => $this->option('force') ?? false ]);
        ...
        $this->callSilent('vendor:publish', [ '--tag' => 'wind-config', '--force' => $this->option('force') ?? false ]);
